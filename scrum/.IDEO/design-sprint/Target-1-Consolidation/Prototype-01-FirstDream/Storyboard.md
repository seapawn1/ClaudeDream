...
| 6 **遇见 connection** | 报告"新连接"条目点开全文："若插件顺序颠倒成限流先于 auth，匿名流量每个请求都写 Redis 计数，能耗尽免费配额——插件顺序是配额的隐形防线，你自己没连起过这条线"（示例因果 2026-08-02 修正） | S7 L1 建 connection（D 主体，复利兑现处） | **Test 关键观察③**：用户反应是"有点东西"还是"废话"——R1 的宣判格 |
