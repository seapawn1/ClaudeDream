...
| 空间 | 阶段 | 说明 |
|---|---|---|
| [claude-dream/](claude-dream/) | ✅ Sprint 4 已交付 | v0.2.0 完整做梦流程：B 读取管线 + C 编译落盘（Target C 首发），DoD 首次全六类生效 — [Sprint 4 Review](ScrumSprint/sprint-04-compile-write/SprintReview.md) |
